...
public class SVProgressHUD {
    ...
    protected void initViews() {
        ...
        rootView = (ViewGroup) layoutInflater.inflate(com.ebei.library.R.layout.layout_svprogresshud, null, false);
    ...
    private void setMaskType(SVProgressHUDMaskType maskType) {
        ...
        switch (mSVProgressHUDMaskType) {
            ...
            case ClearCancel:
                ...
                break;
            case Black:
                configMaskType(com.ebei.library.R.color.bgColor_overlay, true, false);
                break;
            case BlackCancel:
                configMaskType(com.ebei.library.R.color.bgColor_overlay, true, true);
                break;
            case Gradient:
                configMaskType(com.ebei.library.R.drawable.bg_overlay_gradient, true, false);
                break;
            case GradientCancel:
                configMaskType(com.ebei.library.R.drawable.bg_overlay_gradient, true, true);
                break;
            default:
                break;
        }
    ...
    private void setCancelable(boolean isCancelable) {
        View view = rootView.findViewById(com.ebei.library.R.id.sv_outmost_container);
