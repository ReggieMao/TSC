package com.ebei.library.svprogresshud;
...
public class SVProgressDefaultView extends LinearLayout {
    ...
    private int resBigLoading = com.ebei.library.R.mipmap.ic_svstatus_loading;
    private int resInfo = com.ebei.library.R.mipmap.ic_svstatus_info;
    private int resSuccess = com.ebei.library.R.mipmap.ic_svstatus_success;
    private int resError = com.ebei.library.R.mipmap.ic_svstatus_error;
    ...
    private void initViews() {
        LayoutInflater.from(getContext()).inflate(com.ebei.library.R.layout.view_svprogressdefault, this, true);
        ivBigLoading = (ImageView) findViewById(com.ebei.library.R.id.ivBigLoading);
        ivSmallLoading = (ImageView) findViewById(com.ebei.library.R.id.ivSmallLoading);
        circleProgressBar = (SVCircleProgressBar) findViewById(com.ebei.library.R.id.circleProgressBar);
        tvMsg = (TextView) findViewById(com.ebei.library.R.id.tvMsg);
    }
