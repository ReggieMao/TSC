...
public class AutoPullAbleListView extends ListView implements AutoPullAble {
    ...
    public AutoPullAbleListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AutoPullAbleListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    private void init(Context context) {
        View view = LayoutInflater.from(context).inflate(com.ebei.library.R.layout.view_auto_load_more, null);
        mLoadingView = (ImageView) view.findViewById(com.ebei.library.R.id.loading_icon);
        mLoadingView.setBackgroundResource(com.ebei.library.R.drawable.loading_anim);
    ...
    public interface OnLoadListener {
        public void onLoad(AutoPullAbleListView pullAbleListView);
    }
